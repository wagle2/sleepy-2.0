...
var Bus = function(r){
    ...
    I.register("busSelect"+r.sender,r.room,r.sender,function(input){
        ...
        if (this.info.length == 1){
            r.msg = " "+ this.info.Name0;
            //r.replier.reply(info.Id+" "+info.NEXT_BUSSTOP0);
            버스현재위치(r,this.info.Id,this.info.NEXT_BUSSTOP0);
            ...
            if(msg1 == "1"){
                ...
                r.msg = " "+ this.info.Name1;
                버스현재위치(r,this.info.Id,this.info.NEXT_BUSSTOP1);
            } else{
