...
var Weather = function (r){
    ...
    parse = function (r,areaCode,weatherUrl){
        var 한글공백 = String.fromCharCode(12644);
        var 숫자공백 = String.fromCharCode(8199);
        var 투명공백 = String.fromCharCode(8237);
        var cut = String.fromCharCode(8237).repeat(500);
