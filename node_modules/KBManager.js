module.exports = (function(){
   ...
   function DBManagerBuilder(fileName){
      fileName = fileName || "DB";
      if(cache[fileName]){
         return cache[fileName];
      }
      const myDB = android.database.sqlite.SQLiteDatabase.openDatabase(fileName, null, 1);
      ...
      function makeBackup() {
         ...
         var os=new java.io.FileOutputStream(fileName+date.getFullYear()+"_"+(date.getMonth()+1)+"_"+date.getDate()+"_"+date.getHours()+"_"+date.getMinutes()+"_"+date.getSeconds());
         var len=0;
      ...
      function updateOrInsert(table, updateValues, insertValues, whereClause, whereArgs){
         ...
         try{
            ...
            e.message = e.message + "\nupdateOrInsert("+table+", {"+Object.getOwnPropertyNames(updateValues).map(v=>v+":"+updateValues[v])+"}, "+whereClause+", ["+whereArgs+"]";
            throw e;
         }finally{
            lock.unlock();
         }
      ...
      function selectForCursor(table, columns, selection, selectionArgs, options){
         ...
         try{
            ...
            e.message = e.message + "\nselect("+table+", ["+columns+"], "+selection+", ["+selectionArgs+"]";
            throw e;
         }finally{
            lock.unlock();
         }
   ...
   DBManagerBuilder.toString=()=>"function DBManagerBuilder (fileName=\"DB\"){\n\t[native code, arity=1]\n}"
